...
from adv_loss.discriminator_patchgan import NLayerDiscriminator as PatchGANDiscriminator
from adv_loss.discriminator_stylegan import Discriminator as StyleGANDiscriminator
